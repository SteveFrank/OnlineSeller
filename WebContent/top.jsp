...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <li><a href="form.jsp" target="rightFrame"><img src="images/icon05.png" title="审批信息" /><h2>审批信息</h2></a></li>
    ...
    <li><a href="#">关于</a></li>
    <li><a href="<c:url value='/login.jsp' />" target="_parent">退出</a></li>
    </ul>
     
    <div class="user">
    <span>${sessionScope.seller.salename }</span>
    <i>消息</i>
    <b></b>
    </div>    
    </div>
